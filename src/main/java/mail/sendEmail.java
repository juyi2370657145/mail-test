...
public class sendEmail{
	...
	public static String myEmailAccount = "cbw2370657145@163.com";
	public static String myEmailPassword = "VXUVMYCALHNVIAGK";
	...
	// 收件人邮箱（替换为自己知道的有效邮箱）
	public static String receiveMailAccount = "2370657145@qq.com";
